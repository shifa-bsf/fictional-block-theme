...
// Instantiate a new object using above classes
...
class Like {
  ...
  async createLike(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + "/wp-json/university/v1/likes/", data);
...
class MyNotes {
  constructor() {
    // this.myNotesContainer = document.getElementById("my-notes");
    if (document.querySelector("#my-notes")) {
      (axios__WEBPACK_IMPORTED_MODULE_1___default().defaults).headers.common["X-WP-Nonce"] = universityData.nonce;
  ...
  async deleteNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_1___default()["delete"](universityData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"));
      ...
      if (response) {
        document.querySelector("#noteNotice").innerHTML = "";
      }
    } catch (e) {
      alert("Failed!");
    }
  ...
  async updateNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_1___default().post(universityData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"), ourUpdatedPost);
      this.makeNoteReadOnly(thisNote);
    } catch (e) {
      alert("Failed update!");
    }
  ...
  async createNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_1___default().post(universityData.root_url + "/wp-json/wp/v2/note/", newPost);
      console.log(response);
      if (response.status == 200) {
        return document.querySelector("#noteNotice").innerHTML = response.data;
      }
      ...
      if (response.data.userNoteCount == 5) {
        document.querySelector("#noteNotice").innerHTML = "New note created successfully! You have reached your note limit.";
      } else {
        document.querySelector("#noteNotice").innerHTML = "New note created successfully!";
      }
    } catch (e) {
      console.error(e);
    }
